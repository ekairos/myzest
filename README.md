...
I used the W3C [HTML](https://validator.w3.org/) and [CSS](https://jigsaw.w3.org/css-validator/) validators.
...
- HTML warnings :
    ...
    - The warnings and errors concern the Jinja's templating syntax, which is not recognized.
